    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #204051;">
	  ...
	  <div class="container">
		...
		<div class="col-md-8" style="color: black; background-color: whitesmoke; padding-top: 8%">
			<p class="text-dark display-2">Return Item</p>
			<div class="row" style="width: 80%">
				...
				<form  method="post" action="#">
					...
					<div class="col" id="mulre" style="display:none">
						<input type="text" class="form-control" id="numre" name="numre" placeholder="How many items?">
					</div>
			...
			<form  method="post" action="ReturnResult">
				<div class="form-group" style="width: 80%">
					<div class="row">
						<div class="col">
							<label for="RecordID" style="font-size: 30px">Record ID</label>
							<input type="text" class="form-control" id="RecordID" name="RecordID" placeholder="xxxxxxxxxxxxxxx" required minlength="15" maxlength="15" pattern="[0-9]{15}">
							<small id="FindRecordID" class="form-text text-muted">Find Record ID <a href="ManageRecords" style="color: black" target="_blank">here</a></small>
						</div>
					</div>
					<?php 
					error_reporting(0);
					...
					if (isset($acti)){
						...
						for ($x = 2; $x <= $num; $x++) {
							...
							echo '<div class="row">';
							echo '<div class="col">';
							echo '<label for="RecordID'.$x.'" style="font-size: 30px">Record ID #'.$x.'</label>';
							echo '<input type="text" class="form-control" id="RecordID'.$x.'" name="RecordID'.$x.'" placeholder="xxxxxxxxxxxxxxx" required minlength="15" maxlength="15" pattern="[0-9]{15}">';
							echo '</div>';
							echo '</div>';
						}
					}
