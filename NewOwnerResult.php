...
$q="INSERT INTO `owner` (`owner_id`, `first_name`, `surname`, `nickname`, `year`, `faculty`, `tel_no`, `line_id`, `email`) VALUES
('$owner_id', '$first_name', '$surname', '$nickname', '$year', '$faculty', '$tel_no', '$line_id', '$email');";
	  ...
	  <div class="container">
		...
		<div class="col-md-8" style="color: black; background-color: whitesmoke; padding-top: 8%">
			...
			if (mysqli_query($con, $q)) {
			  echo '<p class="text-dark display-2">New owner added successfully!</p>';
			  echo '<br><a href="NewOwner" class="btn btn-success btn-lg">Add more owners</a>&nbsp;';
			  echo '<a href="ManageOwners" class="btn btn-warning btn-lg">Check Owner Table</a>&nbsp;';
			  ...
			  echo '<br><a href="NewOwner" class="btn btn-success btn-lg">Try Again</a>&nbsp;';
			  echo '<a href="ManageOwners" class="btn btn-warning btn-lg">Check Owner Table</a>&nbsp;';
			  echo '<a href="StaffPortal" class="btn btn-secondary btn-lg">Back to home</a>';
			}
			?>
